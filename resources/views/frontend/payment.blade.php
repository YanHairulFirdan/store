                ...
                <div class="box">
                    <form method="POST" action="{{ route('checkout.payment') }}">
                        ...
                        <div class="nav flex-column flex-sm-row nav-pills"><a href="checkout1.html"
                                ...
                                class="nav-link flex-sm-fill text-sm-center active"> <i class="fa fa-money"> </i>Payment
                        ...
                        <div class="box-footer d-flex justify-content-between"><a href="checkout2.html"
                                class="btn btn-outline-secondary"><i class="fa fa-chevron-left"></i>Back to Shipping
                                Method</a>
