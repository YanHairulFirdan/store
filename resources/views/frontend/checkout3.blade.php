    ...
    <div class="container">
        <div class="row">
            ...
            <div id="checkout" class="col-lg-9">
                <div class="box">
                    <form method="post" action="{{ route('cart.delivery') }}">
                        @method('POST')
                        @csrf
                        ...
                        <div class="nav flex-column flex-sm-row nav-pills"><a href="checkout1.html"
                                ...
                                href="checkout2.html" class="nav-link flex-sm-fill text-sm-center active"> <i
                        ...
                        <div class="box-footer d-flex justify-content-between"><a href="checkout1.html"
                                class="btn btn-outline-secondary"><i class="fa fa-chevron-left"></i>Back to address</a>
